...
var moduleMap = {
	...
	"./Widget": () => {
		return Promise.all([__webpack_require__.e(855), __webpack_require__.e(418)]).then(() => (() => ((__webpack_require__(418)))));
	}
};
...
/******/ 					var req = fetch(__webpack_require__.p + "" + {"376":{"341":"937336331972360d7f65"}}[chunkId][wasmModuleId] + ".module.wasm");
/******/ 					var promise;
