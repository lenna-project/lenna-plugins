define("exif_thumbnail", [], () => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
var moduleMap = {
	...
	"./Widget": () => {
		return Promise.all([__webpack_require__.e(748), __webpack_require__.e(787)]).then(() => (() => ((__webpack_require__(787)))));
	}
};
...
/******/ 					var req = fetch(__webpack_require__.p + "" + {"376":{"479":"8de247d3d213616fff1b"}}[chunkId][wasmModuleId] + ".module.wasm");
/******/ 					var promise;
